  ...
  return (
    <div className="p-10">
      ...
      <div className="flex items-center justify-between mt-10 text-center flex-wrap gap-5">
        <button
          className="bg-gray-100 hover:bg-gray-200 transition-all px-5 py-2 rounded text-black w-28"
          onClick={onClick}
        >
          Later
        </button>
        <a
          ...
          target="_parent"
          className="bg-primary_green hover:bg-primary_green/80 transition-all text-white px-5 py-2 cursor-pointer rounded w-28"
